                                ...
                                <nav>
                                    <ul className="flex items-center">
                                        ...
                                        <li className="ml-[15px]">
                                            <a className="flex flex-col items-center cursor-pointer text-white" onClick={handleModal}>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className="hidden lg:block">
                                    <nav className="w-max">
                                        <ul className="flex items-center">
                                            <li className="mx-[15px]">
                                                <Link className="flex flex-col items-center text-white" to="/learning">
                                            ...
                                            <li className="mx-[15px]">
                                                <a className="flex flex-col items-center cursor-pointer text-white">
