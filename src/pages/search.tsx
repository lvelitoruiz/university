...
const Search = ({location}: any) => {
  ...
  const getForTerm = (term: string) => {
    ...
    axios
      .get(process.env.GATSBY_ENDPOINT + `api/info/algolia/search?query=${term}&limit=12&page=0`)
      .then((response) => {
  ...
  const getForCourse = () => {
    axios
      .get(process.env.GATSBY_ENDPOINT + `api/info/algolia/search?limit=12&page=0&facetFilters[type.name]=`)
      .then((response) => {
        if(parseInt(response.data.data.nbPages) > 1) {
          let pagesToUse = [];
          setPage(response.data.data.nbPages);
  ...
  const getCombined = (catTerm: string, sTerm: string) => {
    axios
      .get(process.env.GATSBY_ENDPOINT + `api/info/algolia/search?limit=12&page=0&facetFilters[type.name]=${catTerm}&query=${sTerm}`)
      .then((response) => {
        if(parseInt(response.data.data.nbPages) > 1) {
          let pagesToUse = [];
          setPage(response.data.data.nbPages);
  ...
  const getForCategory = (catTerm: string) => {
    axios
      .get(process.env.GATSBY_ENDPOINT + `api/info/algolia/search?limit=12&page=0&facetFilters[categories.name]=${catTerm}`)
      .then((response) => {
        if(parseInt(response.data.data.nbPages) > 1) {
          let pagesToUse = [];
          setPage(response.data.data.nbPages);
  ...
  const getForSkill = (skillTerm: string) => {
    axios
      .get(process.env.GATSBY_ENDPOINT + `api/info/algolia/search?limit=12&page=0&facetFilters[skills.name]=${skillTerm}`)
      .then((response) => {
        if(parseInt(response.data.data.nbPages) > 1) {
          let pagesToUse = [];
          setPage(response.data.data.nbPages);
  ...
  const getCategories = () => {
    axios
      .get(process.env.GATSBY_ENDPOINT + `api/category`)
      .then((response) => {
        let catElements: any = [];
  ...
  const getSkills = () => {
    axios
      .get(process.env.GATSBY_ENDPOINT + `api/skill`)
      .then((response) => {
  ...
  const handlePagination = (pageIndex: number) => {
    axios
    .get(process.env.GATSBY_ENDPOINT + `api/info/algolia/search?limit=12&page=${pageIndex}${queryCat}${queryList}${querySkill}`)
      .then((response) => {
        if(parseInt(response.data.data.nbPages) > 1) {
          let pagesToUse = [];
          setPage(response.data.data.nbPages);
  ...
  const handleQueryCourse = (term: string) => {
    ...
    axios
    .get(process.env.GATSBY_ENDPOINT + `api/info/algolia/search?limit=12&page=0${newQuery}${querySkill}${queryCat}`)
      .then((response) => {
        if(parseInt(response.data.data.nbPages) > 1) {
          let pagesToUse = [];
          setPage(response.data.data.nbPages);
  ...
  const handleQueryCategory = (term: string) => {
    ...
    axios
    .get(process.env.GATSBY_ENDPOINT + `api/info/algolia/search?limit=12&page=0${newQuery}${queryList}${querySkill}`)
      .then((response) => {
        if(parseInt(response.data.data.nbPages) > 1) {
          let pagesToUse = [];
          setPage(response.data.data.nbPages);
  ...
  const handleQuerySkill = (term: string) => {
    ...
    axios
    .get(process.env.GATSBY_ENDPOINT + `api/info/algolia/search?limit=12&page=0${newQuery}`)
      .then((response) => {
        if(parseInt(response.data.data.nbPages) > 1) {
          let pagesToUse = [];
          setPage(response.data.data.nbPages);
