          ...
          <section className="container px-[15px] mx-auto pt-[40px] lg:pt-[60px] pb-[40px] lg:pb-0">
            <div className="lg:flex lg:items-center lg:justify-between pb-10">
              <div className="flex items-center">
                ...
                <div className="mb-4 md:mb-0">
                  <h2 className="text-[30px] lg:text-[60px] ff-cg--semibold leading-none">Courses</h2>
                </div>
              </div>
            ...
            <div className="lg:flex lg:items-center gap-8 pb-10">
              <div className="shadow-lg flex items-center px-[14px] py-[7px] rounded-2xl w-full cursor-pointer bg-white mb-4 md:mb-0">
                ...
                <input className="w-full ff-cg--semibold placeholder:text-[#000000] p-[10px] focus:outline-none" type="search" placeholder="Search Courses" />
              </div>
                  ...
                  <div className="overflow-x-auto">
                    <table className="lg:w-full rounded-2xl">
                      <thead className="text-white rounded-2xl  border-[#da1a32]">
                        <tr>
                          <th className="bg-[#da1a32] rounded-tl-xl text-left ff-cg--semibold py-4 px-8">Title</th>
                          <th className="bg-[#da1a32] text-left ff-cg--semibold py-4 px-8">Seats</th>
                      ...
                      <tbody className="">
                        <tr className="border-b border-solid">
                          ...
                          <td className="py-4 px-8">
                            <div>
                              <p className="text-[18px] lg:text-[30px]">10/100</p>
                              <div className="w-full bg-[#dddddd] h-2 rounded-full">
                                <div className="bg-[#da1a32] h-2 rounded-full" style={{ width: '15%' }}></div>
                              </div>
                            </div>
                          </td>
                          <td className="py-4 px-8">
                        ...
                        <tr className="border-b border-solid">
                          ...
                          <td className="py-4 px-8">
                            <div>
                              <p className="text-[18px] lg:text-[30px]">20/50</p>
                              <div className="w-full bg-[#dddddd] h-2 rounded-full">
                                <div className="bg-[#da1a32] h-2 rounded-full" style={{ width: '65%' }}></div>
                              </div>
                            </div>
                          </td>
                          <td className="py-4 px-8">
                        ...
                        <tr className="border-b border-solid">
                          ...
                          <td className="py-4 px-8">
                            <div>
                              <p className="text-[18px] lg:text-[30px]">10/100</p>
                              <div className="w-full bg-[#dddddd] h-2 rounded-full">
                                <div className="bg-[#da1a32] h-2 rounded-full" style={{ width: '45%' }}></div>
                              </div>
                            </div>
                          </td>
                          <td className="py-4 px-8">
